#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
# SLURM: Train π0-FAST v2 — 4 GPUs, NO time limit, runs to 30k completion
# ═══════════════════════════════════════════════════════════════════════════════
#SBATCH --job-name=pi0f_v2
#SBATCH --partition=gpu
#SBATCH --gres=gpu:tesla:4
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=128G
#SBATCH --output=/data/beegfs/home/saifi/logs/pi0_fast_v2_%j.out
#SBATCH --error=/data/beegfs/home/saifi/logs/pi0_fast_v2_%j.err
...
VENV="${OPENPI}/.venv"
CONFIG="pi0_fast_ur5e_peg_insertion_v2_lora"
...
echo "═══════════════════════════════════════════════════════════════"
echo "  TRAINING π0-FAST v2 (2-camera, rank=16, 4 GPUs, 30k steps)"
echo "  Config:   ${CONFIG}"
echo "  Exp:      ${EXP_NAME}"
echo "  Node:     $(hostname)"
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  ✓ π0-FAST v2 Training Complete at 30k steps! $(date)"
echo "═══════════════════════════════════════════════════════════════"
